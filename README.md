...
A terminal dashboard that shows your [Claude.ai](https://claude.ai) usage in real time — session limits, weekly quotas, and pay-per-use spend — as live progress bars that count down by the second.
